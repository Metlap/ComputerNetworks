...
#Transport method
def selective_repeat(self, packet_buffer,transport_object):
...
class _client_connection():
  ...
  def create_client_socket(self):
    ...
    try:
      ...
      self.client_socket.settimeout(20)  #5 second time out set
...
if __name__ == '__main__':
  ...
  #connection_handler_selective_repeat(transport, writeObject, connection_object, [], file_name, 'SR')
  t.stop()
